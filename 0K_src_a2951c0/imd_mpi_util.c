...
/*   to->data[ to->n++ ] = DP_P_STAT(p,ind,Z); */
...
#endif /* STRESS_TENS */
#ifdef STRESSAVERAGE
  to->data[ to->n++ ] = PRESSTENSSUM(p,ind,xx);
  to->data[ to->n++ ] = PRESSTENSSUM(p,ind,yy);
  to->data[ to->n++ ] = PRESSTENSSUM(p,ind,xy);
#ifndef TWOD
  to->data[ to->n++ ] = PRESSTENSSUM(p,ind,zz);
  to->data[ to->n++ ] = PRESSTENSSUM(p,ind,yz);
  to->data[ to->n++ ] = PRESSTENSSUM(p,ind,zx);
#endif
#endif
...
#endif
#ifdef SVCT
  to->data[ to->n++ ] = SLIPREFERENCE(p,ind,X);
  to->data[ to->n++ ] = SLIPREFERENCE(p,ind,Y);
  to->data[ to->n++ ] = SLIPREFERENCE(p,ind,Z);
  to->data[ to->n++ ] = SLIPVECTOR(p, ind, X);
  to->data[ to->n++ ] = SLIPVECTOR(p, ind, Y);
  to->data[ to->n++ ] = SLIPVECTOR(p, ind, Z);
#endif
  /* force is not sent */
#ifdef COVALENT
  ...
  to->data[ to->n++ ] = REF_EPOT(p,ind);
  to->data[ to->n++ ] = REF_RHO(p,ind);
}
...
void copy_atom_buf_cell(minicell *p, msgbuf *b, int start)
{
...
#endif /* STRESS_TENS */
#ifdef STRESSAVERAGE
  PRESSTENSSUM(to,ind,xx) = b->data[j++];
  PRESSTENSSUM(to,ind,yy) = b->data[j++];
  PRESSTENSSUM(to,ind,xy) = b->data[j++];
#ifndef TWOD
  PRESSTENSSUM(to,ind,zz) = b->data[j++];
  PRESSTENSSUM(to,ind,yz) = b->data[j++];
  PRESSTENSSUM(to,ind,zx) = b->data[j++];
#endif
#endif
...
#endif
#ifdef SVCT
  SLIPREFERENCE(to,ind,X)  = b->data[j++];
  SLIPREFERENCE(to,ind,Y)  = b->data[j++];
  SLIPREFERENCE(to,ind,Z)  = b->data[j++];
  SLIPVECTOR(to,ind,X) = b->data[j++];
  SLIPVECTOR(to,ind,Y) = b->data[j++];
  SLIPVECTOR(to,ind,Z) = b->data[j++];
#endif
  /* don't send force */
#ifdef COVALENT
  ...
  REF_EPOT(to,ind) = b->data[j++];
  REF_RHO(to,ind)  = b->data[j++];
}
