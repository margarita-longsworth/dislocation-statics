...
#define REF_RHO(cell,i)         ((cell)->refRho[i])
#define REF_EPOT(cell,i)         ((cell)->refEpot[i])
...
#endif
#ifdef STRESSAVERAGE
#define VOLUME(cell,i)			 (((cell)->vol[i]))
#define PRESSTENSSUM(cell,i,sub) ((cell)->presstensSum[i].sub)
#endif
#ifdef SVCT
#define SLIPVECTOR(cell,i,sub)    ((cell)->slipVector sub(i))
#define SLIPREFERENCE(cell,i,sub) ((cell)->slipReference sub(i))
#endif
#ifdef NYETENSOR
