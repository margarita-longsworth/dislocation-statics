...
#endif
#ifdef SVCT
    SLIPREFERENCE(to,i,X) = SLIPREFERENCE(from,i,X) + v.x;
    SLIPREFERENCE(to,i,Y) = SLIPREFERENCE(from,i,Y) + v.y;
    SLIPREFERENCE(to,i,Z) = SLIPREFERENCE(from,i,Z) + v.z;
#endif
...
#endif
#ifdef VIRTUAL_ATOMS
    b->data[ j++ ] = (real) VSORTE(from,i);
#endif
#ifdef SVCT
    b->data[ j++ ] = SLIPREFERENCE(from,i,X) + v.x;
    b->data[ j++ ] = SLIPREFERENCE(from,i,Y) + v.y;
    b->data[ j++ ] = SLIPREFERENCE(from,i,Z) + v.z;
#endif
#ifdef UNIAX
...
#endif
#ifdef VIRTUAL_ATOMS
    VSORTE(to,i) = (shortint) b->data[ j++ ];
#endif
#ifdef SVCT
    SLIPREFERENCE(to,i,X) = b->data[ j++ ];
    SLIPREFERENCE(to,i,Y) = b->data[ j++ ];
    SLIPREFERENCE(to,i,Z) = b->data[ j++ ];
#endif
#ifdef UNIAX
